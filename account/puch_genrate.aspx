<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="puch_genrate.aspx.cs" Inherits="Default2" %>
                        ...
                        <center>
                            <table>
                                <tr style="background-color: #EFF3FB; height: 35px;">
                                    ...
                                    <td>
                                          <asp:TextBox ID="txt_puch_no" Width="75%" runat="server"></asp:TextBox>
                                    </td>
                                    <td style="font-weight: bold; text-align: right;">
                                        Company Name&nbsp;
                                    </td>
                                    ...
                                    <asp:TemplateField HeaderText="Rate">
                                        <ItemTemplate>
                                            <asp:TextBox ID="TextBox4" Width="55px" runat="server" AutoPostBack="True" OnTextChanged="TextBox4_TextChanged"
                                                Style="text-align: right" OnPreRender="TextBox4_PreRender"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <td>
                                        <table>
                                            <tr style="background-color: #EFF3FB; height: 35px;">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_amt_vat4" Width="75%" runat="server" OnPreRender="txt_amt_vat4_PreRender"
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_amt_vat12" Width="75%" runat="server" OnPreRender="txt_amt_vat12_PreRender"
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_amt_cst2" Width="75%" runat="server" OnPreRender="txt_amt_cst2_PreRender"
                                            ...
                                            <tr style="background-color: #EFF3FB; height: 35px;">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txt_tax2" Width="75%" runat="server" OnPreRender="txt_tax2_PreRender"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-weight: bold; text-align: right;">
                                    ...
                                    <td>
                                        <table style="margin-left: 245px; margin-top: -30px;">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="TextBox9" Width="85px" runat="server" AutoPostBack="True" OnTextChanged="TextBox9_TextChanged"
