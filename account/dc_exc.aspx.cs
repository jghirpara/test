...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txt_inv_time.Text = System.DateTime.Now.TimeOfDay.ToString();
            fillvoucher();
    ...
    protected void TextBox4_TextChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            txt_amt_exc.Text = tax7.ToString();
            ...
            //}
            txt_amt_exc.Text = amtexp.ToString();
            txt_dis.Focus();
            // fillcat();
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        //try
        //{
        //    if (DropDownList1.SelectedItem.Text == "Excise And Duty")
        //    {
        //        
        //        SetInitialRow();
        //        for (int i = 1; i <= 4; i++)
        ...
        try
        {
            if (txt_amt_exc.Text != string.Empty)
            {
                if (vat == "4%")
                {
                    ...
                    double fecc = ecc * 12.5 / 100;
                    txt_exc.Text = fecc.ToString();
                    txt_amt_vat4.Text = Convert.ToString(Convert.ToDouble(txt_amt_vat4.Text) + Convert.ToDouble(txt_exc.Text));
                    double vat1 = Convert.ToDouble(txt_amt_vat4.Text) * 4 / 100;
                    double advat = Convert.ToDouble(txt_amt_vat4.Text) * 1 / 100;
                    txt_tax4.Text = vat1.ToString();
                    txt_vat1.Text = advat.ToString();
                    ...
                    else
                    {
                        ...
                        {
                            double dic = Convert.ToDouble(TextBox9.Text);
                            double net = Convert.ToDouble(txt_amt_vat4.Text) + Convert.ToDouble(txt_tax4.Text) + Convert.ToDouble(txt_vat1.Text) + Convert.ToDouble(txt_txt12.Text) + Convert.ToDouble(txt_vat2.Text) + Convert.ToDouble(txt_tax2.Text) - dic;
                            txt_net_amt.Text = net.ToString();
                        }
                        else
                        {

                            double net = Convert.ToDouble(txt_amt_vat4.Text) +Convert.ToDouble(txt_tax4.Text) + Convert.ToDouble(txt_vat1.Text) + Convert.ToDouble(txt_txt12.Text) + Convert.ToDouble(txt_vat2.Text) + Convert.ToDouble(txt_tax2.Text);
                            txt_net_amt.Text = net.ToString();
                        }
                        fillcat();
                    }
                ...
                else if (vat == "12%")
                {
                    ...
                    double fecc = ecc * 12.5 / 100;
                    txt_exc.Text = fecc.ToString();
                    txt_amt_vat12.Text = Convert.ToString(Convert.ToDouble(txt_amt_vat12.Text) + Convert.ToDouble(txt_exc.Text));
                    double vat1 = Convert.ToDouble(txt_amt_vat12.Text) * 12.5 / 100;
                    double advat = Convert.ToDouble(txt_amt_vat12.Text) * 2.5 / 100;
                    txt_txt12.Text = vat1.ToString();
                    txt_vat2.Text = advat.ToString();
                    ...
                    else
                    {
                        ...
                        {
                            double dic = Convert.ToDouble(TextBox9.Text);
                            double net = Convert.ToDouble(txt_amt_vat12.Text) + Convert.ToDouble(txt_tax4.Text) + Convert.ToDouble(txt_vat1.Text) + Convert.ToDouble(txt_txt12.Text) + Convert.ToDouble(txt_vat2.Text) + Convert.ToDouble(txt_tax2.Text) - dic;
                            txt_net_amt.Text = net.ToString();
                        }
                        else
                        {

                            double net = Convert.ToDouble(txt_amt_vat12.Text) + Convert.ToDouble(txt_tax4.Text) + Convert.ToDouble(txt_vat1.Text) + Convert.ToDouble(txt_txt12.Text) + Convert.ToDouble(txt_vat2.Text) + Convert.ToDouble(txt_tax2.Text);
                            txt_net_amt.Text = net.ToString();
                        }
                        fillcat();
                    }
    ...
    protected void dwd_vat_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Panel2.Visible = true;
            DropDownList1.Visible = false;
            vat = dwd_vat.SelectedValue.ToString();
            dwd_vat.Visible = false;
            txt_comp_nm.Focus();
            //if (vat == "4%")
            //{
            //    txt_amt_vat12.Visible = false;
            //    txt_txt12.Visible = false;
            //    txt_vat2.Visible = false;
            //    lbl_amt_12.Visible = false;
            //    lbl_vat_12.Visible = false;
            //    lbl_addvat_2.Visible = false;


            //}
            //else if (vat == "12%")
            //{
            //    txt_amt_vat4.Visible = false;
            //    txt_tax4.Visible = false;
            //    txt_vat1.Visible = false;
            //    lbl_amt_4.Visible = false;
            //    lbl_vat_4.Visible = false;
            //    lbl_addvat_1.Visible = false;
            //}
        }
        catch
        {
